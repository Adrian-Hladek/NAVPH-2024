...
public class HoverHighlight : MonoBehaviour
{
    ...
    public GameObject requiredInvalidObject;
    ...
    private void Awake()
    {
        ...
        {
            firstCollider = colliders[0]; // Store the collider with ID 0
        }
    ...
    private void OnMouseEnter()
    {
        ...
        if (firstCollider != null && ObjectPickup.heldObject == null || ObjectPickup.heldObject != requiredInvalidObject)
        {
    ...
    */
    ...
    private void Update()
    {
        ...
        if (ObjectPickup.heldObject == null || ObjectPickup.heldObject != requiredInvalidObject)
        {
