...
public class PathDelete : MonoBehaviour
{
    ...
    [SerializeField] public GameObject requiredDeleteObject;  // Optional: Specify which object needs to be held for rotation
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (ObjectPickup.heldObject == requiredDeleteObject)
            {
    ...
    private void HandleClick(GameObject clickedObject)
    {
        ...
        RemovePathToBunka(clickedObject);
    ...
    private void RemovePathToBunka(GameObject Bunka)
    {
        ...
        if (bunkaChange != null)
        {
            ...
            bunkaChange.HasPathValue = false; // Set the property value
